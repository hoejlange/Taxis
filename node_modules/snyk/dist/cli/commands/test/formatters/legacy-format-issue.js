...
const snykModule = require("snyk-module");
...
function formatIssues(vuln, options) {
    ...
    const vulnOutput = {
        issueHeading: createSeverityBasedIssueHeading(vuln.metadata.severity, vuln.metadata.type, vuln.metadata.name, false),
        ...
        const upgradePathsArray = _.uniq(vuln.list.map((v) => {
            ...
            if (shouldUpgradeItself) {
                ...
                const selfUpgradeInfo = v.upgradePath.length > 0
                    ...
                    : '';
                const testedPackageName = snykModule(v.upgradePath[0]);
